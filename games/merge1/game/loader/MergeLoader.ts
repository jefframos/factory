...
export default class MergeLoader extends LoaderScene {
    ...
    public async build() {
        ...
        this.patternBg = new PatternBackground({ background: 0x26C6DA, patternPath: 'merge1/images/non-preload/jiggy-pattern.webp', patternAlpha: 0.2 });
        ...
        this.progress = new NineSliceProgressBarAsync({
            width: 300,
            height: 40,
            bgPath: 'merge1/images/non-preload/bg_loader.webp',
            barPath: 'merge1/images/non-preload/fill_loader.webp',
            slices: [10, 10, 10, 10],
