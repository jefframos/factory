    ...
    public static createDefault5m(): TimedRewardRegistry {
        return new TimedRewardRegistry({
            ...
            cycle: [
                ...
                { id: "gems_3", reward: { kind: "gems_fixed", gems: 15 }, icon: PIXI.Texture.from(MergeAssets.Textures.Icons.Gem) },
                ...
                { id: "gems_5", reward: { kind: "gems_fixed", gems: 30 }, icon: PIXI.Texture.from(MergeAssets.Textures.Icons.GemPile) },
