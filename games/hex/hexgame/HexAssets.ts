...
//     }
// };
export default class HexAssets {
...
export const SHOP_STYLE_CONFIG = {
    Window: {
        ...
        Textures: {
            Background: HexAssets.Textures.UI.RowLock,
            TabActive: HexAssets.Textures.Buttons.Orange,
            CloseBtn: HexAssets.Textures.Buttons.Red,
            CloseIcon: "Icon_Close02",
            NavBtn: HexAssets.Textures.Buttons.Blue,
            NavDisabled: HexAssets.Textures.Buttons.Grey,
        }
    },
    Item: {
        HEIGHT: 150,
        ...
        TEXT_OFFSET_X: 150,
        Textures: {
            RowBgActive: HexAssets.Textures.UI.ShopBgActive,
            RowBg: HexAssets.Textures.UI.ShopBgDisabled,
            BuyBtn: HexAssets.Textures.Buttons.Green,
            BuyDisabled: HexAssets.Textures.Buttons.Grey,
            LockIcon: HexAssets.Textures.Icons.Lock,
        }
    }
};