...
export class PieceAnimations {
    ...
    static readonly SHOOT_DURATION = 0.24;
    private static readonly SHOOT_SCALE_AMPLITUDE = 0.55;

    /** Decaying squash + wiggle — trigger once on the piece's first physical contact with anything, and never again after. */
    static readonly JIGGLE_DURATION = 0.6;
    private static readonly JIGGLE_FREQUENCY = 3.5;
    private static readonly JIGGLE_ROTATION_AMPLITUDE = 0.24;
    private static readonly JIGGLE_SQUASH_AMPLITUDE = 0.45;
