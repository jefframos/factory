...
export const ISLAND_TILE_DEFS: Record<string, TileConfig> = {
    ...
    sand: { height: 0.03, color: 0x2a3a4a, depthBelow: 5, radius: 0, fadeFrom: 0, fadeTo: -10 },
    ...
    rock: { height: 5, color: 0x2a3a4a, depthBelow: 2, radius: 0.5, opacity: 1, fadeFrom: 0, fadeTo: -10 },
};
