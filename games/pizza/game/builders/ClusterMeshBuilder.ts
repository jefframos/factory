// Ported from games/clog/game/builders/ClusterMeshBuilder.ts, unchanged — see
// IslandMeshBuilder.ts for the pizza-specific caller (flood-fills TileMap's
// Tiled ground cells into per-tile-name blobs instead of clog's procedural
// noise grid, but feeds them into this exact same builder).
